 ...
 /*
        ...
        return an array of scalar values); expected, also an array of scalar values, should be
        ...
        As this code demonstrates, we cannot compare arrays directly. For more information
        on this topic, please consult the lesson named Notes on Memory, which can be found
        in the Reference Answers and In Depth Documentation section at end of this Module.
        With that in mind, there are typically two things that we must check in order to
        determine that two arrays of scalar values are indeed equal to one another. Do they
        have the same length, and do they contain the same values. Thus, your function must
        make a determination about these issues, then either log a passing message to the
        console or else a failure message. See the examples below for precise details on the
        messages to be logged to the console.
        ...
        Rather, they are presented to aid your understanding of how assertArraysEqual
